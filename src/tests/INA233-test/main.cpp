...
INA233 ina(0x41);  // IC1 address 0x45 1000101 
...
void setup() {
  ...
  while(1){
      int16_t raw_vbus_IC1=0;
        ...
        raw_vbus_IC1=ina.getBusVoltage_raw();
        raw_vshunt_IC1=ina.getShuntVoltage_raw();
        raw_current_IC1=ina.getCurrent_raw();
        raw_power_IC1=ina.getPower_raw();
        ...
        vbus_IC1=ina.getBusVoltage_V();
        vshunt_IC1=ina.getShuntVoltage_mV();
        current_IC1=ina.getCurrent_mA();
        power_IC1=ina.getPower_mW();
